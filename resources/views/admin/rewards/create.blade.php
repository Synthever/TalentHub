...
@section('content')
    ...
    <div class="mx-auto max-w-2xl">
        <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 class="mb-6 text-xl font-semibold text-slate-900">Tambah Reward Baru</h2>
            ...
            <form action="{{ route('admin.rewards.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="4"
                        ...
                        placeholder="Jelaskan detail reward, syarat & ketentuan...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" name="poin_dibutuhkan" id="poin_dibutuhkan" value="{{ old('poin_dibutuhkan') }}" required min="1"
